...
public class AlarmAdapter extends BaseAdapter {
    ...
    public AlarmAdapter(Context context, List<Map<String, String>> mapList, String url) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (linearLayout == null) {
            ...
            holder.name = (TextView) linearLayout.findViewById(R.id.bell_name);
        ...
        if (tag == position) {
            ...
            holder.musicIcon.setTextColor(grayColor);
